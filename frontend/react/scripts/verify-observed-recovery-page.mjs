...
try {
  ...
  const selected="ac38a842-83cd-4a3b-baea-10888b611dc4";
  ...
  await page.screenshot({path:"../../docs/architecture/opentelemetry-corrected-recovery-page-2026-09-07.png",fullPage:true});
  ...
  writeFileSync("../../docs/architecture/opentelemetry-corrected-recovery-page-2026-09-07.json",JSON.stringify(result,null,2));
