...
import { ClipboardCheck, Link2, Save } from "lucide-react";
    ...
    <section className="cloud-ops-route" aria-labelledby="service-onboarding-title">
      <article className="cloud-ops-panel">
        ...
        <p className="field-hint">
          <Link2 size={13} aria-hidden="true" style={{ verticalAlign: "-2px" }} /> Need to attach a ticketing platform or monitoring tool to this service? <Link to="/cloud-ops/connections">Connect your tools</Link> before saving this profile.
        </p>
      </article>
