...
const IncidentCommand = resilientLazy(() => import("../features/incidents/IncidentCommand"));
const ApprovalsRoute = resilientLazy(() => import("../routes/approvals/ApprovalsRoute"));
const EvidenceRequestsRoute = resilientLazy(() => import("../routes/evidence-requests/EvidenceRequestsRoute"));
...
const ROUTE_COMPONENTS: Readonly<Record<NavigationId, ComponentType>> = {
  ...
  evidenceRequests: EvidenceRequestsRoute,
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      { path: "/incidents/:incidentId", element: routeElement(IncidentCommand) },
