...
export type NavigationIcon = "dashboard" | "alerts" | "incidents" | "approvals" | "evidenceRequests" | "copilot" | "agentFlow" | "knowledge" | "safety" | "audit" | "closed" | "applications" | "operationsCockpit" | "cloudConnections" | "cloudResources" | "serviceOnboarding" | "services" | "integrations" | "platformOverview" | "admin" | "settings" | "executive";
...
export const NAVIGATION_ITEMS: readonly NavigationItem[] = [
  { id: "dashboard", legacyTab: "home", path: "/", label: "Overview", pageTitle: "Operations Overview", description: "See what needs attention now and continue the highest-priority work.", group: "operations", routeModule: "dashboard", icon: "dashboard", keywords: ["operations", "overview", "command center"], allowedRoles: ALL_ROLES },
  { id: "incidents", legacyTab: "summary", path: "/incidents", label: "Incidents", pageTitle: "Incidents", description: "Review active incidents, investigate evidence, and decide the next safe action.", group: "operations", routeModule: "incidents", icon: "incidents", keywords: ["signals", "alerts", "case", "investigate", "evidence", "rca"], allowedRoles: ALL_ROLES, related: ["alerts", "approvals"] },
  ...
  { id: "cloudResources", legacyTab: "admin", path: "/cloud-ops/resources", label: "Resources", pageTitle: "Resource Inventory", description: "Find monitored resources, their owners, tags, and service relationships.", group: "operations", routeModule: "cloud-ops/resources", icon: "cloudResources", keywords: ["estate", "inventory", "resources", "topology", "cloud"], allowedRoles: ADMIN_ROLES, related: ["cloudConnections", "services"] },
  { id: "copilot", legacyTab: "copilot", path: "/copilot", label: "Ask Kai", pageTitle: "Ask Kai", description: "Ask operational questions and review answers grounded in approved evidence.", group: "intelligence", routeModule: "copilot", icon: "copilot", keywords: ["kai", "assistant", "analysis", "insight"], allowedRoles: ALL_ROLES },
  { id: "knowledge", legacyTab: "rag", path: "/knowledge", label: "Runbooks & Knowledge", pageTitle: "Runbooks & Knowledge", description: "Review and approve the documents Kai may use during investigations.", group: "intelligence", routeModule: "knowledge", icon: "knowledge", keywords: ["rag", "documents", "runbooks"], allowedRoles: ADMIN_ROLES },
  ...
  { id: "evidenceRequests", legacyTab: "approval", path: "/evidence-requests", label: "Evidence Requests", pageTitle: "Evidence Requests", description: "Answer the investigations across every incident that are waiting on a verified human observation.", group: "automation", routeModule: "evidence-requests", icon: "evidenceRequests", keywords: ["evidence", "human evidence", "assignment blocked", "context gap", "queue"], allowedRoles: ALL_ROLES, related: ["incidents", "approvals"] },
  { id: "operationsCockpit", legacyTab: "admin", path: "/cloud-ops/cockpit", label: "Automation Readiness", pageTitle: "Automation Readiness", description: "Check which automated actions are configured, safe, and available.", group: "automation", routeModule: "cloud-ops/cockpit", icon: "operationsCockpit", keywords: ["capabilities", "automation", "readiness", "execution"], allowedRoles: ADMIN_ROLES, related: ["cloudResources", "services"] },
  { id: "platformOverview", legacyTab: "admin", path: "/platform", label: "Platform Health", pageTitle: "Platform Health", description: "Check service readiness, data flow, AI availability, and governance controls.", group: "platform", routeModule: "platform", icon: "platformOverview", keywords: ["platform", "control plane", "health", "governance"], allowedRoles: ADMIN_ROLES, related: ["cloudConnections", "admin", "operationsCockpit"] },
  { id: "cloudConnections", legacyTab: "admin", path: "/cloud-ops/connections", label: "Connections", pageTitle: "Connections", description: "Connect ticketing platforms, monitoring tools, and cloud providers, then verify that Kai can read them.", group: "platform", routeModule: "cloud-ops/connections", icon: "cloudConnections", keywords: ["integrations", "connectors", "cloud", "providers", "jira", "servicenow", "azure devops", "prometheus", "grafana", "datadog", "knowledge base"], allowedRoles: ADMIN_ROLES, related: ["cloudResources", "services"] },
  ...
  { id: "closed", legacyTab: "closed", path: "/closed-incidents", label: "Closed Incidents", pageTitle: "Closed Incidents", description: "Verified outcomes and immutable decision history.", group: "operations", routeModule: "closed-incidents", icon: "closed", keywords: ["resolved", "historical", "outcomes"], allowedRoles: ALL_ROLES, related: ["incidents"] },
  ...
  { id: "audit", legacyTab: "audit", path: "/audit", label: "Audit Log", pageTitle: "Audit Log", description: "Review who changed what, when it happened, and the recorded governance decision.", group: "platform", routeModule: "audit", icon: "audit", keywords: ["health", "history", "audit", "compliance"], allowedRoles: ADMIN_ROLES },
