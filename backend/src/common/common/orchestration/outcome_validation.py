...
def decide_closed_loop(
    ...
    *,
    ...
    if execution_succeeded and (collection_pending or (not missing and not failed)) and not stability_window_complete:
        return ClosedLoopDecision(
...
def decide_outcome_validation(
    *,
    ...
    elif (independent_checks_passed or collection_pending) and not stability_passed:
